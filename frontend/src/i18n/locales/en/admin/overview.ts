export default {
    ...
    renewal: {
      ...
      description: 'Configure renewal eligibility, discounts, unused-credit rollover, reminder schedules, and email templates.',
      orderNotice: 'Rules are calculated and snapshotted only when a new subscription order is created. Existing orders are not changed and no in-system refund is triggered. Rollover credit is added to the user balance after payment and successful fulfillment.',
      baseTitle: 'Campaign and Eligibility',
      baseHint: 'The master switch controls the campaign. Submodule settings can still be prepared while it is off, but nothing is applied to users.',
      running: 'Campaign active',
      stopped: 'Campaign stopped',
      offerEnabled: 'Enable renewal campaign',
      offerEnabledHint: 'When enabled, eligible renewal orders can receive discounts or rollover credit and campaign emails may be sent.',
      beforeDays: 'Eligible days before expiry',
      beforeDaysHint: 'How many days before expiry the renewal benefits begin. Use 0 to start at expiry.',
      afterDays: 'Eligible days after expiry',
      afterDaysHint: 'How many days after expiry benefits remain available. Use 0 to stop at expiry.',
      daysUnit: 'days',
      eligibilityPreview: 'Eligibility window: {before} days before through {after} days after expiry. Renewals are matched by user and subscription group.',
      discountTitle: 'Renewal Discount',
      discountHint: 'Controls the amount due for new renewal orders. The discount is snapshotted when the order is created.',
      discountEnabled: 'Enable renewal discount',
      discountEnabledHint: 'Disable discounts independently while keeping rollover credit or reminder emails.',
      discountPercent: 'Discount percentage',
      discountMinOrder: 'Minimum order amount for discount',
      discountMaxAmount: 'Maximum discount per order',
      discountPreview: 'Example: list price {amount}, renewal discount {discount}, discounted amount {payable}. Minimum order and cap settings may further limit the result.',
      rolloverTitle: 'Unused-Credit Rollover',
      rolloverHint: 'Remaining credit is the subscription group monthly limit minus current monthly usage; the configured share is then added to balance credit.',
      rolloverEnabled: 'Enable unused-credit rollover',
      rolloverEnabledHint: 'Disable rollover independently while keeping discounts or email reminders. Credit is granted idempotently after payment succeeds.',
      rolloverPercent: 'Rollover percentage',
      rolloverMinUnused: 'Minimum unused credit to qualify',
      rolloverMaxAmount: 'Maximum rollover credit per order',
      rolloverPreview: 'Example: unused monthly credit {unused}, estimated rollover {rollover}. Minimum unused credit and cap settings may further limit the result.',
      zeroNoLimit: 'Use 0 for no threshold or cap.',
      emailTitle: 'Renewal Email Reminders',
      emailHint: 'Manage the email switch, reminder milestones, and template here. Each subscription is emailed at most once per milestone.',
      emailEnabled: 'Enable renewal campaign emails',
      emailEnabledHint: 'The email switch is independent from discount and rollover switches, but still follows the campaign master switch.',
      reminderDays: 'Pre-expiry reminder milestones',
      reminderDaysHint: 'Select multiple milestones or add a custom day. Every milestone must be inside the pre-expiry eligibility window.',
      expiryDay: 'On expiry day',
      daysBefore: '{day} days before',
      customReminderPlaceholder: 'Custom days before',
      reminderRequired: 'At least one reminder milestone is required while email is enabled.',
      invalidReminderDay: 'Reminder day must be an integer from 0 through {max}.',
      invalidForm: 'Check the renewal campaign ranges, percentages, and reminder milestones.',
      saved: 'Renewal campaign settings saved',
      movedHint: 'Renewal settings now have a dedicated page for independent switches, thresholds, caps, and email templates.',
      openSettings: 'Open renewal settings',
      errors: { loadFailed: 'Failed to load renewal campaign settings' }
    },
    ...
    affiliates: {
	  ...
	  settings: {
		title: 'Affiliate Campaign Settings',
		description: 'Configure recharge rebates, the rebate wallet, first-usage rewards, and referral risk controls.',
		creditNotice: 'First-usage rewards are internal billing credits added to the inviter balance. They are not cash and do not trigger an in-system refund.',
		baseTitle: 'Affiliate Base Rules',
		baseHint: 'Control invite binding, recharge rebates, and rebate wallet usage.',
		enabled: 'Enable affiliate rebates',
		enabledHint: 'When disabled, no new invite binding, rebate, or first-usage reward is created.',
		rebateRate: 'Recharge rebate rate',
		freezeHours: 'Rebate freeze period (hours)',
		durationDays: 'Rebate validity (days)',
		perInviteeCap: 'Lifetime rebate cap per invitee',
		discountEnabled: 'Allow rebate wallet order discounts',
		discountEnabledHint: 'Users may apply available rebate credit to part of an order.',
		discountMaxPercent: 'Maximum discount per order',
		discountMinPay: 'Minimum paid credit per order',
		usageRewardTitle: 'First-Usage Referral Reward',
		usageRewardHint: 'The inviter receives one reward when the invitee first incurs positive actual usage cost. Each invitee can trigger at most once.',
		usageRewardEnabled: 'Enable first-usage rewards',
		usageRewardEnabledHint: 'Configure risk thresholds before enabling. Disabled by default.',
		rewardAmount: 'Reward credits',
		rewardAmountHint: 'Defaults to 20 and is added directly to the inviter billing balance.',
		riskTitle: 'Reward Risk Controls',
		riskHint: 'A reward matching any rule is held for review and is not added automatically.',
		openReview: 'Open reward reviews',
		inviterDailyLimit: 'Inviter reward limit per 24 hours',
		inviter30dLimit: 'Inviter reward limit per rolling 30 days',
		ipDailyLimit: 'Trigger limit per IP per 24 hours',
		zeroUnlimited: 'Use 0 to disable this count limit.',
		reviewSameIP: 'Review when inviter and invitee IPs match',
		reviewSameIPHint: 'Compares the trigger IP with the inviter’s latest successful usage IP.',
		reviewMissingIP: 'Review when trigger IP is unavailable',
		reviewMissingIPHint: 'Batch jobs or an incomplete proxy chain will not be auto-granted.',
		saved: 'Affiliate settings saved'
	  },
	  rewards: {
		title: 'First-Usage Reward Reviews',
		description: 'Inspect auto-granted and risk-held rewards and resolve pending records.',
		searchPlaceholder: 'Search inviter or invitee email and username',
		allStatuses: 'All statuses',
		empty: 'No first-usage rewards yet',
		review: 'Review',
		reviewTitle: 'Review affiliate reward',
		reviewSummary: '{amount} credits; risk reason: {reason}',
		reviewRemark: 'Review remark',
		reviewRemarkPlaceholder: 'Optional verification details or handling notes',
		approve: 'Approve and grant',
		reject: 'Reject reward',
		approved: 'Reward approved and granted',
		rejected: 'Reward rejected',
		columns: { inviter: 'Inviter', invitee: 'Invitee', amount: 'Credits', status: 'Status', riskReason: 'Risk reason', triggerIP: 'Trigger IP', createdAt: 'Triggered at', actions: 'Actions' },
		status: { pending: 'Pending', granted: 'Granted', rejected: 'Rejected' },
		reasons: { auto_granted: 'Auto granted', missing_ip: 'Missing trigger IP', same_ip: 'Inviter and invitee IP match', inviter_daily_limit: 'Inviter 24-hour limit', inviter_30d_limit: 'Inviter 30-day limit', ip_daily_limit: 'IP 24-hour limit', manual_approved: 'Manually approved', manual_rejected: 'Manually rejected' }
	  },
      errors: {
