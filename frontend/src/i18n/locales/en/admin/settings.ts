    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new payments generate no rebate. Existing CNY rebates remain available for checkout discounts or admin withdrawal.',
          rebateRate: 'Global Rebate Rate',
          rebateRateHint: 'Default percentage of the invitee\'s actual paid amount returned to the inviter (0-100, e.g. 10 = 10%).',
      ...
      platformQuota: {
        ...
        monthly:     'Monthly (points, rolling 30d)',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many points the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {points} points',
		renewalOffer: 'Subscription renewal offer',
		renewalOfferHint: 'Within the configured days before or after expiry, apply a renewal discount and carry part of unused monthly credit to balance.',
		renewalWindowDays: 'Renewal window (days each side)',
		renewalDiscountPercent: 'Renewal discount (%)',
		renewalRolloverPercent: 'Unused monthly credit rollover (%)',
		renewalEmail: 'Send renewal offer email',
