export default {
  ...
  affiliate: {
    ...
    records: {
      ...
      allTypes: 'All Types',
      actions: { accrue: 'Invite Rebate', discount: 'Purchase Discount', withdraw: 'Offline Payout' },
      columns: { type: 'Type', amount: 'Amount', sourceOrder: 'Source Order', availableAfter: 'Available Credit', status: 'Status', createdAt: 'Time' },
      status: { posted: 'Posted', frozenUntil: 'Frozen until {time}', deducted: 'Deducted', withdrawn: 'Paid out' }
    },
    tips: {
      title: 'How It Works',
