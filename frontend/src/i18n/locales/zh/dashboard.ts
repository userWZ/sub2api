export default {
  ...
  affiliate: {
    ...
    records: {
      ...
      empty: '暂无返利额度记录',
      allTypes: '全部类型',
      actions: { accrue: '邀请返利', discount: '购买抵扣', withdraw: '线下提现' },
      columns: { type: '类型', amount: '金额', sourceOrder: '关联订单', availableAfter: '可用额度', status: '状态', createdAt: '时间' },
      status: { posted: '已入账', frozenUntil: '冻结至 {time}', deducted: '已扣减', withdrawn: '已提现' }
    },
    tips: {
      title: '使用说明',
      line1: '将邀请码或邀请链接分享给新用户。',
      line2: '被邀请用户充值后，你可获得 {rate} 的返利额度。',
      line3: '可用返利会在购买余额或订阅时作为抵扣选项。',
