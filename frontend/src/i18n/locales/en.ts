export default {
  ...
  nav: {
    ...
    affiliateTransferRecords: 'Wallet Records',
    profile: 'Profile',
    users: 'Users',
  ...
  availableChannels: {
    ...
    description: 'Services, models, and pricing currently available to your account',
    searchPlaceholder: 'Search services or models...',
    empty: 'No available services',
    noModels: 'No models configured',
    noPricing: 'Pricing not configured',
    exclusive: 'Dedicated Credit',
    public: 'Shared Credit',
    exclusiveTooltip: 'Dedicated subscription granted by an admin',
    publicTooltip: 'Shared subscription available to all users',
    serviceOverviewEyebrow: 'Service Capability',
    serviceOverviewTitle: 'AI services available to this account',
    serviceOverviewDescription: 'The first row uses user-facing capabilities. Advanced details below keep exact models and pricing for troubleshooting.',
    viewServiceStatus: 'View Service Status',
    serviceAvailable: 'Available',
    serviceUnavailable: 'Unavailable',
    serviceIncluded: 'Included in current services',
    serviceNoModel: 'Not currently open',
    serviceModelCount: '{count} models available',
    serviceImageCount: '{count} image models available',
    services: {
      text: 'Text Chat',
      code: 'Code Assistant',
  ...
  admin: {
    ...
    users: {
      ...
      keyQuotaDisabled: 'Key quota disabled',
      keyQuotaEnabled: 'Key quota enabled',
      disableKey: 'Disable',
      enableKey: 'Enable',
      disableKeyQuota: 'Disable quota',
      enableKeyQuota: 'Enable quota',
      keyPolicyUpdated: 'Key settings updated',
      keyPolicyUpdateFailed: 'Failed to update key settings',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: 'Available Services',
          description: 'Show logged-in users the service capabilities, models, and pricing notes they can access. Disabled by default.',
          configureLink: 'Configure model pricing in Channel Management > Channel Pricing',
          enabled: 'Enable Available Services',
