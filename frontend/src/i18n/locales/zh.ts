export default {
  ...
  availableChannels: {
    title: '可用服务',
    description: '查看当前账号可使用的服务能力、模型和计费说明',
    ...
    exclusive: '专属额度',
    public: '通用额度',
    exclusiveTooltip: '管理员授权给你的专属订阅',
    publicTooltip: '所有用户可用的通用订阅',
    serviceOverviewEyebrow: '服务能力',
    serviceOverviewTitle: '当前账号可用的 AI 服务',
    serviceOverviewDescription: '这里先按普通用户能理解的能力展示。下方高级明细仍保留具体模型和计费信息，方便需要时排查。',
    viewServiceStatus: '查看服务状态',
    serviceAvailable: '可用',
    serviceUnavailable: '不可用',
    serviceIncluded: '已包含在当前可用服务中',
    serviceNoModel: '当前未开放',
    serviceModelCount: '{count} 个模型可用',
    serviceImageCount: '{count} 个生图模型可用',
    services: {
      text: '文本对话',
      code: '代码助手',
      image: '图片生成',
  ...
  admin: {
    ...
    users: {
      ...
      keyQuotaDisabled: '禁用 Key 额度',
      keyQuotaEnabled: '启用 Key 额度',
      disableKey: '停用',
      enableKey: '启用',
      disableKeyQuota: '禁用额度',
      enableKeyQuota: '启用额度',
      keyPolicyUpdated: 'Key 设置已更新',
      keyPolicyUpdateFailed: '更新 Key 设置失败',
      noUsersYet: '暂无用户',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '可用服务',
          description: '向已登录用户展示他们能访问的服务能力、模型和计费说明。默认关闭。',
