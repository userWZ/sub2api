...
func init() {
	...
	// apikeyDescQuotaDisabled is the schema descriptor for quota_disabled field.
	apikeyDescQuotaDisabled := apikeyFields[8].Descriptor()
	// apikey.DefaultQuotaDisabled holds the default value on creation for the quota_disabled field.
	apikey.DefaultQuotaDisabled = apikeyDescQuotaDisabled.Default.(bool)
	...
	paymentorderDescOriginalAmount := paymentorderFields[5].Descriptor()
	// paymentorder.DefaultOriginalAmount holds the default value on creation for the original_amount field.
	paymentorder.DefaultOriginalAmount = paymentorderDescOriginalAmount.Default.(float64)
	// paymentorderDescAffiliateDiscount is the schema descriptor for affiliate_discount field.
	paymentorderDescAffiliateDiscount := paymentorderFields[6].Descriptor()
	// paymentorder.DefaultAffiliateDiscount holds the default value on creation for the affiliate_discount field.
	paymentorder.DefaultAffiliateDiscount = paymentorderDescAffiliateDiscount.Default.(float64)
	// paymentorderDescRenewalDiscount is the schema descriptor for renewal_discount field.
	paymentorderDescRenewalDiscount := paymentorderFields[7].Descriptor()
	// paymentorder.DefaultRenewalDiscount holds the default value on creation for the renewal_discount field.
	paymentorder.DefaultRenewalDiscount = paymentorderDescRenewalDiscount.Default.(float64)
	// paymentorderDescRenewalRolloverAmount is the schema descriptor for renewal_rollover_amount field.
	paymentorderDescRenewalRolloverAmount := paymentorderFields[8].Descriptor()
	// paymentorder.DefaultRenewalRolloverAmount holds the default value on creation for the renewal_rollover_amount field.
	paymentorder.DefaultRenewalRolloverAmount = paymentorderDescRenewalRolloverAmount.Default.(float64)
	// paymentorderDescFeeRate is the schema descriptor for fee_rate field.
	paymentorderDescFeeRate := paymentorderFields[12].Descriptor()
	...
	userDescCustomerType := userFields[7].Descriptor()
	// user.DefaultCustomerType holds the default value on creation for the customer_type field.
	user.DefaultCustomerType = userDescCustomerType.Default.(string)
