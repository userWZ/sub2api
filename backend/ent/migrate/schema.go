...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "quota_disabled", Type: field.TypeBool, Default: false},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "original_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "affiliate_discount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "renewal_discount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "renewal_rollover_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "renewal_source_subscription_id", Type: field.TypeInt64, Nullable: true},
		{Name: "renewal_source_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "customer_type", Type: field.TypeString, Size: 20, Default: "direct"},
