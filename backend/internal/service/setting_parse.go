...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyAffiliateUsageRewardAmount:                strconv.FormatFloat(AffiliateUsageRewardAmountDefault, 'f', 2, 64),
		SettingKeyAffiliateRewardInviterDailyLimit:          strconv.Itoa(AffiliateRewardInviterDailyLimitDefault),
		SettingKeyAffiliateRewardInviter30DayLimit:          strconv.Itoa(AffiliateRewardInviter30DayLimitDefault),
		SettingKeyAffiliateRewardIPDailyLimit:               strconv.Itoa(AffiliateRewardIPDailyLimitDefault),
		SettingKeyAffiliateRewardReviewSameIP:               "true",
		SettingKeyAffiliateRewardReviewMissingIP:            "true",
