...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentRenewalOfferEnabled:                             paymentCfg.RenewalOfferEnabled,
		PaymentRenewalWindowDays:                               paymentCfg.RenewalWindowDays,
		PaymentRenewalRolloverPercent:                          paymentCfg.RenewalRolloverPercent,
		PaymentRenewalDiscountPercent:                          paymentCfg.RenewalDiscountPercent,
		PaymentRenewalEmailEnabled:                             paymentCfg.RenewalEmailEnabled,
