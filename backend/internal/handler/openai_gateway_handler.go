...
func (h *OpenAIGatewayHandler) ResponsesWebSocket(c *gin.Context) {
	...
	var billingErr error
	subscription, billingErr = checkBillingEligibilityWithBalanceFallback(ctx, h.billingCacheService, h.apiKeyService, h.subscriptionService, apiKey, subscription, service.QuotaPlatform(c.Request.Context(), apiKey))
	if billingErr != nil {
